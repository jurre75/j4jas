...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.28.1/darwin-2level'),
    ...
    libpth => '/usr/local/lib /Applications/Xcode-9.4.1.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/9.1.0/lib /Applications/Xcode-9.4.1.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib /usr/lib',
    osname => 'darwin',
    osvers => '17.4.0',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.28.1'),
    scriptdir => relocate_inc('.../'),
    sitearchexp => relocate_inc('.../../lib/site_perl/5.28.1/darwin-2level'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.28.1'),
    so => 'dylib',
    useithreads => undef,
